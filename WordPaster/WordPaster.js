...
function WordPasterManager()
{
	...
	this.OpenDialogFile = function ()
	{
	    ...
	    {
	        _this.filesPanel.show();
	        // 定义图片上传对话框
	        _this.DlgWordUploader = new Ext.Window({
	            contentEl: "FilePostLister", //主体显示的html元素，也可以写为el:"win"
	            width: 450,
	            height: 500,
	            resizable: false,
	            modal: true,
	    ...
	    _this.DlgWordUploader.show();
	};
	this.CloseDialogFile = function ()
	{
	    _this.DlgWordUploader.hide();
	};
	...
	this.OpenDialogPaste = function ()
	{
	    ...
	    {
	        _this.imgPasterDlg.show();
	        //文件，剪帖板图片上传窗口
	        _this.DlgImageUploader = new Ext.Window({
	            contentEl: "PasterMessager", //主体显示的html元素，也可以写为el:"win"
	            width: 300,
	            height: 200,
	            resizable: false,
	            modal: true,
	    ...
	    _this.DlgImageUploader.show();
	};
	this.CloseDialogPaste = function ()
	{
	    _this.DlgImageUploader.hide();
	};
	...
	this.PasteManual = function ()
	{
	    ...
	    else
	    {
	        ...
	        else _this.Editor.execCommand('paste');
	    }
	};
